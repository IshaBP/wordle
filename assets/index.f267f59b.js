...
`,z=()=>{const e=O();return t=>{if("animate"in document.body){const r=document.querySelector(`[aria-label=keyboard] button[data-code="${t}"]`);r&&r.animate([{backgroundColor:e.keyPressBgColor}],100)}}},D=e=>{d.exports.useEffect(()=>{const t=r=>{const s=r.key.toLowerCase();s==="enter"?e("<ENT>"):s==="backspace"?e("<BKSP>"):W(s)&&e(s)};return window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}},[e])},k={a:"a".charCodeAt(0),z:"z".charCodeAt(0)},W=e=>{const t=e.charCodeAt(0);return e.length===1&&k.a<=t&&t<=k.z},U=[["q","w","e","r","t","y","u","i","o","p"],["a","s","d","f","g","h","j","k","l"],["<ENT>","z","x","c","v","b","n","m","<BKSP>"]],Z=({keyMatchStatusMap:e,onKey:t})=>{const r=z(),s=o=>{t(o),r(o)};return D(s),a(h,{as:"section","aria-label":"keyboard",gap:"0.25rem",column:!0,width:"100%",children:U.map((o,n)=>a(V,{rowIndex:n,keyRow:o,onKey:s,keyMatchStatusMap:e},n))})},V=({rowIndex:e,keyRow:t,keyMatchStatusMap:r,onKey:s})=>I(h,{"aria-label":"key-row",gap:"0.25rem",center:!0,width:"100%",children:[e===1&&a(T,{flex:.5}),t.map(o=>a(j,{code:o,onClick:s,status:r[o]},o)),e===1&&a(T,{flex:.5})]}),J=({game:e,latestRowStatus:t})=>a(h,{as:"section",column:!0,gap:"0.5rem","aria-label":"wordboard",children:e.map((r,s)=>a(h,{"aria-label":"guess-word",gap:"0.5rem",children:r.map((o,n)=>a(Q,{"aria-label":"letter",status:o.matchStatus,children:o.matchStatus==="INITIAL"?"":o.key.toUpperCase()},n))},s))}),Q=R(h).attrs({center:!0})`
  ...
  font-size: 2rem;
  font-weight: bold;
`,X=["allow","angel","baton","beads","baths","basis","glean","nudge","nuked","ounce"],N=e=>X.includes(e),Y=()=>"angel",A=(e,t)=>{for(let r=0;r<e.length;r++)t(e[r],r)};var c;class ee{constructor(t){x(this,c,new Map);A(t,r=>{this.increment(r)})}has(t){return m(this,c).has(t)&&this.get(t)!==0}get(t){var r;return(r=m(this,c).get(t))!=null?r:0}increment(t){this.has(t)?m(this,c).set(t,this.get(t)+1):m(this,c).set(t,1)}decrement(t){this.has(t)&&m(this,c).set(t,this.get(t)-1)}}c=new WeakMap;const te=(e,t)=>{if(e.length!==t.length)throw new Error("chosenWord and guessWord should be of equal length");if(!N(e)||!N(t))return null;if(e===t)return new Array(e.length).fill("MATCH");const r=new ee(e),s=[];return A(t,(o,n)=>{e[n]===o?(s[n]="MATCH",r.decrement(o)):s[n]="NO_MATCH"}),A(t,(o,n)=>{s[n]==="NO_MATCH"&&r.has(o)&&(s[n]="PARTIAL_MATCH",r.decrement(o))}),s},re=()=>{const e=d.exports.useMemo(()=>Y(),[]),t=d.exports.useRef(!1),[r,s]=d.exports.useState(ne),[o,n]=d.exports.useState({}),[i,L]=d.exports.useState(0),[l,y]=d.exports.useState(0);return I(h,{"aria-label":"game",column:!0,height:"100%",alignItems:"center",justifyContent:"space-around",padding:"0 0.75rem",children:[a(J,{game:r,latestRowStatus:"IN_PROGRESS"}),a(Z,{keyMatchStatusMap:o,onKey:b=>{if(!t.current){if(b==="<BKSP>"){if(l>0){const u=[...r];u[i][l-1]={key:void 0,matchStatus:"INITIAL"},s(u),y(l-1)}}else if(b==="<ENT>"){if(l===5){const u=r[i].map(f=>f.key).join(""),p=te(e,u);if(p){const f=[...r];for(let g=0;g<p.length;g++)f[i][g].matchStatus=p[g];s(f),n(se(f[i],o)),oe(p)?t.current=!0:i<5?(L(i+1),y(0)):t.current=!0}}}else if(l<5){const u=[...r];u[i][l]={key:b,matchStatus:"IN_PROGRESS"},s(u),y(l+1)}}}})]})},oe=e=>e.every(t=>t==="MATCH"),ne=()=>new Array(6).fill(null).map(()=>new Array(5).fill(null).map(()=>({key:void 0,matchStatus:"INITIAL"}))),se=(e,t)=>{const r={INITIAL:0,IN_PROGRESS:1,NO_MATCH:2,PARTIAL_MATCH:3,MATCH:4},s=(o,n)=>o==null?n:r[o]>r[n]?o:n;for(let{key:o,matchStatus:n}of e)o&&(t[o]=s(t[o],n));return S({},t)},ae={textColor:"#FFFFFF",bgColor:"#000000",borderColor:"#3A3A3C",keyPressBgColor:"#545556",matchStatus:{INITIAL:"#818384",MATCH:"#538D4E",NO_MATCH:"#3A3A3C",PARTIAL_MATCH:"#B59F3B",IN_PROGRESS:void 0}},ie=B`
  html {
...
`,ce=()=>I(F,{theme:ae,children:[a(ie,{}),a("main",{className:"App",children:a(re,{})})]});G.render(a(H.StrictMode,{children:a(ce,{})}),document.getElementById("root"));
